    ...
    <body  style="background-color:gold;text-align:center">
       ...
       ?>
        ...
        <br><br>
         ...
         <br>
         **************************************************************************************
        <h2>Send Single Notification To Captain  :</h2>
        <form action="sendSinglePushToCaptain.php" method="POST" enctype="multipart/form-data">
        
            <br>   Title:<br> <input type='texte' name='title'>
            <br>   Message :<br> <input type='texte' name='message'>
